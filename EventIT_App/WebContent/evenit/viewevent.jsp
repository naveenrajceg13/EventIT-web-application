		...
		<table class="table table-bordered">
            ...
            <tr>
                <td colspan="3" style="text-align:center">
                	...
                	<input type="button" value="Approve" id="approve" class="btn btn-primary" style="margin-right: 50px;background-color:#1B7B98" />
                	<input type="button" value="Reject" id="reject" class="btn btn-primary" style="background-color:#1B7B98" />
                </td>
            </tr>
        </table>
    </section>
