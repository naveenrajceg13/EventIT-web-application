...
<body>
    ...
    <section id="home">	
    <form id="login_check">
		<div id="main-slider" class="carousel slide" data-ride="carousel" style="height: 650px;">
    ...
    <div class="modal-content" style="color:black">
      ...
      <table>
          <tr>
              ...
              <td><input type="text" placeholder="Email" class="form-control" style="width:400px" /></td>
          </tr>
          <tr>
              <td><label>Password </label></td>
              <td><input type="text" placeholder="Password" class="form-control" style="width:400px" /></td>
          </tr>
          <tr>
              <td><label>Confirm Password </label></td>
              <td><input type="text" placeholder="Confirm Password" class="form-control" style="width:400px" /></td>
          </tr>
          <tr>
              <td><label>First Name </label></td>
              <td><input type="text" placeholder="First Name" class="form-control" style="width:400px" /></td>
          </tr>
          <tr>
              <td><label>Last Name </label></td>
              <td><input type="text" placeholder="Last Name" class="form-control" style="width:400px" /></td>
          </tr>
          <tr>
              <td><label>Phone </label></td>
              <td><input type="text" placeholder="Phone" class="form-control" style="width:400px" /></td>
          </tr>
          <tr>
              <td><label>Address </label></td>
              <td><textarea placeholder="Address" class="form-control" style="width:400px"></textarea></td>
          </tr>
