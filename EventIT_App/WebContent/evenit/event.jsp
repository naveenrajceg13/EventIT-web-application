			...
			<div class="container">
				<div class="row">	        		
		            ...
		            <div class="collapse navbar-collapse">
		                    ...
		                    <li class="scroll active nav navbar-nav navbar-right"><a href="event.jsp">Create Event</a></li>
    ...
    <section id="create" style="min-height:500px;margin-top:95px;position:relative;color:black;width:80%;">	
		<table class="table table-bordered">
			...
			<tr>
                ...
                <td><input type="text" placeholder="Total tickets for the event" id="numticket" class="form-control" name="tickets"  /></td>
            </tr>
